  ...
  <body class="vertical-layout vertical-menu-collapsible page-header-dark vertical-modern-menu 2-columns" data-open="click" data-menu="vertical-modern-menu" data-col="2-columns">
    ...
    <aside class="sidenav-main nav-expanded nav-lock nav-collapsible sidenav-light sidenav-active-square">
      <div class="brand-sidebar">
        ...
        <li class="bold"><a class="collapsible-body active" class="waves-cyan " href="MapasMentais.php"><i class="material-icons">import_contacts</i><span class="menu-title" data-i18n="">Mapas mentais</span></a>
        </li>
          ...
          <div class="container">
            <div class="row">
              <div class="col s10 m6 l6">
                <h5 class="breadcrumbs-title mt-0 mb-0">Mapas Mentais para estudar</h5>
  ...
  <div class="row">
    ...
    <div class="col s12 m6 l4">
      <div class="card-panel border-radius-6 mt-10 card-animation-1">
        <a href="#"><img class="responsive-img border-radius-8 z-depth-4 image-n-margin" src="img/Mapas/1M.jpg"
            alt=""></a>
        <h6 class="deep-purple-text text-darken-3 mt-5"><a href="#">Genética</a></h6>
        <span></span>
        <div class="row mt-4">
    ...
    <div class="col s12 m6 l4">
      <div class="card-panel border-radius-6 mt-10 card-animation-1">
        <a href="#"><img class="responsive-img border-radius-8 z-depth-4 image-n-margin" src="img/Mapas/2M.jpeg"
            alt=""></a>
        <h6 class="deep-purple-text text-darken-3 mt-5"><a href="#">Platão</a></h6>
        <span></span>
        <div class="row mt-4">
          <div class="col s5 mt-1">
            <span class="pt-2">Study Today</span>
    ...
    <div class="col s12 m6 l4">
      <div class="card-panel border-radius-6 mt-10 card-animation-1">
        <a href="#"><img class="responsive-img border-radius-8 z-depth-4 image-n-margin" src="img/Mapas/3M.jpeg"
            alt=""></a>
        <h6 class="deep-purple-text text-darken-3 mt-5"><a href="#">Rochas</a></h6>
        <span>
        </span>
        <div class="row mt-4">
    ...
    <div class="col s12 m6 l4">
      <div class="card-panel border-radius-6 mt-10 card-animation-1">
        <a href="#"><img class="responsive-img border-radius-8 z-depth-4 image-n-margin" src="img/Mapas/4M.jpeg"
            alt=""></a>
        <h6 class="deep-purple-text text-darken-3 mt-5"><a href="#">Revolução francesa</a></h6>
        <span> </span>
        <div class="row mt-4">
          <div class="col s5 mt-1">
            <span class="pt-2">Study Today</span>
    ...
    <div class="col s12 m6 l4">
      <div class="card-panel border-radius-6 mt-10 card-animation-1">
        <a href="#"><img class="responsive-img border-radius-8 z-depth-4 image-n-margin" src="img/Mapas/5M.jpg"
            alt=""></a>
        <h6 class="deep-purple-text text-darken-3 mt-5"><a href="#">Aristóteles</a></h6>
        <span></span>
        <div class="row mt-4">
          <div class="col s5 mt-1">
            <span class="pt-2">Study Today</span>
    ...
    <div class="col s12 m6 l4">
      <div class="card-panel border-radius-6 mt-10 card-animation-1">
        <a href="#"><img class="responsive-img border-radius-8 z-depth-4 image-n-margin" src="img/Mapas/6M.jpeg"
            alt=""></a>
        <h6 class="deep-purple-text text-darken-3 mt-5"><a href="#">Período regencial</a></h6>
        <span>
        </span>
        <div class="row mt-4">
          <div class="col s5 p-0 mt-1">
    ...
    <div class="col s12 m6 l4">
      <div class="card-panel border-radius-6 mt-10 card-animation-1">
        <a href="#"><img class="responsive-img border-radius-8 z-depth-4 image-n-margin" src="img/Mapas/7M.jpeg"
            alt=""></a>
        <h6 class="deep-purple-text text-darken-3 mt-5"><a href="#">Modelos de produção</a></h6>
        <span> </span>
        <div class="row mt-4">
          <div class="col s5 mt-1">
            <span class="pt-2">Study Today</span>
    ...
    <div class="col s12 m6 l4">
      <div class="card-panel border-radius-6 mt-10 card-animation-1">
        <a href="#"><img class="responsive-img border-radius-8 z-depth-4 image-n-margin" src="img/Mapas/8M.jpg"
            alt=""></a>
        <h6 class="deep-purple-text text-darken-3 mt-5"><a href="#">Estados</a></h6>
        <span></span>
        <div class="row mt-4">
          <div class="col s5 mt-1">
            <span class="pt-2">Study Today</span>
    ...
    <div class="col s12 m6 l4">
      <div class="card-panel border-radius-6 mt-10 card-animation-1">
        <a href="#"><img class="responsive-img border-radius-8 z-depth-4 image-n-margin" src="img/Mapas/9M.jpeg"
            alt=""></a>
        <h6 class="deep-purple-text text-darken-3 mt-5"><a href="#">Guerra fria</a></h6>
        <span>
        </span>
        <div class="row mt-4">
          <div class="col s5 p-0 mt-1">
